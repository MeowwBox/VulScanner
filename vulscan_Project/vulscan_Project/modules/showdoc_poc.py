...
class POC:
    ...
    def showdoc_poc(self, url, filename="passer.php", filedata="passer-W", type="poc"):
        encoded_data = self.requestUtil.get_file_data(filename, filedata, "editormd-image-file")
